...
import { ArrowLeft, Video, Sparkles, Check, Play, Zap, PlayCircle, Eye, Share2, Rocket } from 'lucide-react';
import { useNavigate } from 'react-router-dom';

const FeatureImageToVideo = () => {
            ...
            <div className="container" style={{ maxWidth: '1000px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '6rem' }}>
                    <div style={{
                        ...
                        margin: '0 auto 2rem', border: '1px solid rgba(168, 85, 247, 0.2)'
                    }}>
                        <Video size={40} />
                    </div>
                    <h1 className="title-gradient" style={{ fontSize: '4.5rem', marginBottom: '1.5rem', lineHeight: 1.1, letterSpacing: '-0.04em' }}>
                        Static to <span style={{ fontFamily: 'serif', fontWeight: 400 }}>Cinematic</span>. <br /> Effortlessly.
                    </h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '1.4rem', maxWidth: '700px', margin: '0 auto' }}>
                        Turn your product photos into scroll-stopping video content optimized for every social platform.
                    </p>
                </div>

                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '2rem', marginBottom: '6rem' }}>
                    {[
                        { icon: Eye, title: "3x More Engagement", text: "Video content traditionally earns 300% more interaction than static images." },
                        { icon: Share2, title: "Social-First", text: "Optimized for Instagram Reels, TikTok, and YouTube Shorts." },
                        { icon: Zap, title: "Zero Production Time", text: "No cameras, no lighting crew. Just your images and our AI." }
                    ].map((item, i) => (
                        <div key={i} className="glass" style={{ padding: '2.5rem', borderRadius: '2rem', textAlign: 'center' }}>
                            <div style={{ color: '#a855f7', marginBottom: '1.5rem', display: 'flex', justifyContent: 'center' }}>
                                <item.icon size={32} />
                            </div>
                ...
                <div className="glass" style={{
                    ...
                    <p style={{ marginTop: '1.5rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>Get 500 extra coins on launch day.</p>
                </div>
            </div>
        </div>
    );
...
export default FeatureImageToVideo;
